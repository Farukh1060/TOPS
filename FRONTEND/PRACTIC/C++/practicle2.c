...
int main(){
    	...
    	int bye_more;
    	int total_amount;
    	int total_amount_of_water_bottle;
    	int total_amount_of_food;
		   ...
		   //-------------------big bottle--------------------                    	
			...
			//-------------------wrong input--------------------      	    
			 ...
			 printf("value of j %d",j);	
		      total_amount_of_water_bottle = ((i)*5) + ((j)*15);
			  	printf("%d",total_amount_of_water_bottle);		
			break;
//		case 2:
//			int food;
//			
...
//		       
//          }while(i==i&&j==j);
//            total_amount_of_food== (i+1)*150 + (j+1)*100;	 
//		printf("%d",total_amount_of_food);
//		break;
//		
	}
	printf("total bill = %d",(total_amount_of_water_bottle)+(total_amount_of_food));
}
